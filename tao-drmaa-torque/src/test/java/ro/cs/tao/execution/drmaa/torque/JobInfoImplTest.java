...
import ro.cs.tao.execution.drmaa.DrmaaJobInfo;
...
public class JobInfoImplTest {
    ...
    @Before
    public void setUp() {
        // DrmaaJobInfo(String jobId, int exited, int signaled, int coredump, int aborted, String[] resourceUsage, int exitStatus, String signal)
        ji_ok = new DrmaaJobInfo("12345", 1, 0, 0, 0,
                                 new String[]{"cpu_time=1000", "mem_usage=1024"},
                                 0, null);
        ji_sig = new DrmaaJobInfo("12346", 0, 1, 0, 0,
                                  new String[]{"cpu_time=100", "mem_usage=1024"},
                                  145, SIGTERM);
        ji_core = new DrmaaJobInfo("12348", 0, 0, 1, 0,
                                   new String[]{"cpu_time=100", "mem_usage=2048"},
                                   139, SIGSEGV);
        ji_abort = new DrmaaJobInfo("12347", 0, 0, 0, 1,
                                    new String[]{}, 1, null);
    }
    ...
    /**
     * Test of getExitStatus method, of class com.sun.grid.drmaa.DrmaaJobInfo.
     */
    @Test
    ...
    /**
     * Test of getTerminatingSignal method, of class com.sun.grid.drmaa.DrmaaJobInfo.
     */
    @Test
    ...
    /**
     * Test of hasCoreDump method, of class com.sun.grid.drmaa.DrmaaJobInfo.
     */
    @Test
    ...
    /**
     * Test of hasExited method, of class com.sun.grid.drmaa.DrmaaJobInfo.
     */
    @Test
    ...
    /**
     * Test of hasSignaled method, of class com.sun.grid.drmaa.DrmaaJobInfo.
     */
    @Test
    ...
    /**
     * Test of wasAborted method, of class com.sun.grid.drmaa.DrmaaJobInfo.
     */
    @Test
