 ...
 */
public class TorqueSessionFactory extends AbstractSessionFactory {
    ...
    @Override
    protected Session createSession() { return new TorqueSession(); }

    @Override
    protected String getJniLibraryName() { return "libdrmaa-jni-torque.so"; }
