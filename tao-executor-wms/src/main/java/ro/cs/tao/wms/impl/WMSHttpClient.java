...
public class WMSHttpClient extends SimpleHttpClient {
    private final Logger logger = Logger.getLogger(WMSHttpClient.class.getName());
    private final WebServiceAuthentication authentication;

    public WMSHttpClient(WebServiceAuthentication authentication) {
        super();
