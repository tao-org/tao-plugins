...
public interface CommandLineTool extends Process, Saveable {
  ...
  void setId(java.util.Optional<String> id);
  /**
  ...
  void setClass_(CommandLineTool_class class_);
  /**
  ...
  void setLabel(java.util.Optional<String> label);
  /**
  ...
  void setInputs(java.util.List<Object> inputs);
  /**
  ...
  void setOutputs(java.util.List<Object> outputs);
  /**
  ...
  void setRequirements(java.util.Optional<java.util.List<Object>> requirements);
  /**
  ...
  void setHints(java.util.Optional<java.util.List<Object>> hints);
  /**
  ...
  void setCwlVersion(java.util.Optional<CWLVersion> cwlVersion);
  /**
  ...
  void setIntent(java.util.Optional<java.util.List<String>> intent);
  /**
  ...
  void setBaseCommand(Object baseCommand);
  /**
  ...
  void setArguments(java.util.Optional<java.util.List<Object>> arguments);
  /**
  ...
  void setSuccessCodes(java.util.Optional<java.util.List<Object>> successCodes);
  /**
  ...
  void setTemporaryFailCodes(java.util.Optional<java.util.List<Object>> temporaryFailCodes);
  /**
  ...
  void setPermanentFailCodes(java.util.Optional<java.util.List<Object>> permanentFailCodes);
}
