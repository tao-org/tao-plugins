...
public class CommandLineToolImpl extends SaveableImpl implements CommandLineTool {
  ...
  public void setId(java.util.Optional<String> id) {
    this.id = id;
  }
  ...
  public void setClass_(CommandLineTool_class class_) {
    this.class_ = class_;
  }
  ...
  public void setLabel(java.util.Optional<String> label) {
    this.label = label;
  }
  ...
  public void setOutputs(java.util.List<Object> outputs) {
  ...
  public void setRequirements(java.util.Optional<java.util.List<Object>> requirements) {
  ...
  public void setHints(java.util.Optional<java.util.List<Object>> hints) {
    this.hints = hints;
  }
  ...
  public void setCwlVersion(java.util.Optional<CWLVersion> cwlVersion) {
  ...
  public void setIntent(java.util.Optional<java.util.List<String>> intent) {
    this.intent = intent;
  }
  ...
  public void setArguments(java.util.Optional<java.util.List<Object>> arguments) {
  ...
  public void setSuccessCodes(java.util.Optional<java.util.List<Object>> successCodes) {
  ...
  public void setTemporaryFailCodes(java.util.Optional<java.util.List<Object>> temporaryFailCodes) {
  ...
  public void setPermanentFailCodes(java.util.Optional<java.util.List<Object>> permanentFailCodes) {
  ...
  public Map<Object, Object> save() {
    ...
    if (this.label != null && this.label.isPresent() && !this.label.isEmpty()) {
      commandLineTool.put("label",this.label.get());
    }
    if (this.doc != null) {
      commandLineTool.put("doc",this.doc);
    }
    ...
    if (this.requirements != null) {
      ...
      commandLineTool.put("requirements", reqList);
    }
    if (this.arguments != null) {
      List<Object> argumentsList = new LinkedList<>();
      for(Object arg : this.arguments.get()) {
        if(arg instanceof CommandLineBindingImpl) {
          ...
          argumentsList.add(new TreeMap<>(argList).descendingMap());
        } else if(arg instanceof Saveable) {
          argumentsList.add(((Saveable) arg).save());
        }
      }
