...
public class WorkflowImpl extends SaveableImpl implements Workflow {
  ...
  public void setLoadingOptions_(LoadingOptions loadingOptions_) {
    this.loadingOptions_ = loadingOptions_;
  }

  public void setExtensionFields_(Map<String, Object> extensionFields_) {
    this.extensionFields_ = extensionFields_;
  }
  ...
  public void setClass_(Workflow_class class_) {
    this.class_ = class_;
  }
  ...
  public void setRequirements(Optional<List<Object>> requirements) {
    this.requirements = requirements;
  }

  public void setHints(Optional<List<Object>> hints) {
    this.hints = hints;
  }

  public void setCwlVersion(Optional<CWLVersion> cwlVersion) {
    this.cwlVersion = cwlVersion;
  }

  public void setIntent(Optional<List<String>> intent) {
    this.intent = intent;
  }
  ...
  public  Map<Object, Object> save() {
    ...
    if (this.label != null && this.label.isPresent() && !this.label.isEmpty()) {
      workflow.put("label",this.label.get());
    }
    if (this.doc != null) {
    ...
    if (steps != null) {
      ...
      try {
        for (Object step: steps) {
          ...
          if (stepId != "") {
            stepList.put(stepId, temp);
          }
        }
        workflow.put("steps", stepList);
      } catch (Exception e) {
