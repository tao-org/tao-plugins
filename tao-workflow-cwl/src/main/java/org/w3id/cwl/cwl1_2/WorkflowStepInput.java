...
public interface WorkflowStepInput extends Identified, Sink, LoadContents, Labeled, Saveable {
  ...
  void setLinkMerge(java.util.Optional<LinkMergeMethod> linkMergeMethod);
  /**
  ...
  void setPickValue(java.util.Optional<PickValueMethod> pickValue);
  /**
  ...
  void setValueFrom(Object valueFrom);
}
