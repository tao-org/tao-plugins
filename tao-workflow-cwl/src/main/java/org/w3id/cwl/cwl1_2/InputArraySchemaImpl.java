 ...
 */
public class InputArraySchemaImpl extends SaveableImpl implements InputArraySchema {
  ...
  /**
   * Used by {@link org.w3id.cwl.cwl1_2.utils.RootLoader} to construct instances of InputArraySchemaImpl.
   *
  ...
  public InputArraySchemaImpl(
    ...
    if (!(__doc_ instanceof java.util.Map)) {
      throw new ValidationException("InputArraySchemaImpl called on non-map");
    }
