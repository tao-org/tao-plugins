...
/**
* Auto-generated interface for <I>https://w3id.org/cwl/cwl#WorkflowInputParameter</I><BR>This interface is implemented by {@link WorkflowInputParameterImpl}<BR>
 */
public interface WorkflowInputParameter extends InputParameter, Saveable {
  /**
  ...
  void setSecondaryFiles(Object secondaryFiles);
  /**
  ...
  void setStreamable(java.util.Optional<Boolean> streamable);
  /**
  ...
  void setLoadContents(java.util.Optional<Boolean> contents);
  /**
  ...
  void setLoadListing(java.util.Optional<LoadListingEnum> loadListing);
  /**
  ...
  java.util.Optional<InputBinding> getInputBinding();

  void setInputBinding(java.util.Optional<InputBinding> inputBinding);
}
