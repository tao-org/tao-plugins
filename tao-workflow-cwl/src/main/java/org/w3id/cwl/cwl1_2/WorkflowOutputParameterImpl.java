...
public class WorkflowOutputParameterImpl extends SaveableImpl implements WorkflowOutputParameter {
  ...
  public void setSecondaryFiles(Object secondaryFiles) {
    this.secondaryFiles = secondaryFiles;
  }

  public void setStreamable(Optional<Boolean> streamable) {
  ...
  public void setOutputSource(Object outputSource) {
    this.outputSource = outputSource;
  }

  public void setLinkMerge(Optional<LinkMergeMethod> linkMerge) {
    this.linkMerge = linkMerge;
  }

  public void setPickValue(Optional<PickValueMethod> pickValue) {
