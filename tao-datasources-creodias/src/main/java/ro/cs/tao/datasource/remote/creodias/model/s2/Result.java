...
public class Result {
    ...
    @JsonProperty("missionTakeId")
    public String getMissionTakeId() {
        return missionTakeId;
    }

    @JsonProperty("missionTakeId")
    public void setMissionTakeId(String missionTakeId) {
        this.missionTakeId = missionTakeId;
    }

    public Result withMissionTakeId(String missionTakeId) {
        this.missionTakeId = missionTakeId;
        return this;
    }
