 ...
 * @author Cosmin Cara
 */
public class TheiaQueryResponseHandler implements JSonResponseHandler<EOProduct> {
    private final DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ssZ");
