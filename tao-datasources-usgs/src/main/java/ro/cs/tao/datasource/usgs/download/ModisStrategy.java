...
public class ModisStrategy extends SimpleArchiveDownloadStrategy {
    private static final String ZIP_EXTENSION = ".zip";
    private static final String TAR_GZ_EXTENSION = ".tar.gz";
    private static final String KMZ_EXTENSION = ".kmz";
    private static final String HDF_EXTENSION = ".hdf";

    public ModisStrategy(USGSDataSource dataSource, String targetFolder, Properties properties) {
        super(dataSource, targetFolder, properties);
    }

    protected ModisStrategy(ModisStrategy other) {
        super(other);
    }

    @Override
    public ModisStrategy clone() {
        return new ModisStrategy(this);
    }
    ...
    protected Path downloadProduct(EOProduct product, HttpURLConnection connection) throws IOException {
        ...
        try {
            ...
            String extension = getExtensionFromUrl(productUrl).isEmpty() ? HDF_EXTENSION : getExtensionFromUrl(productUrl);
