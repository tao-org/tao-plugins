...
#  Default: ''
c.NotebookApp.certfile = '/home/jovyan/jupyterlite.pem'
...
#  Default: ''
c.NotebookApp.custom_display_url = os.environ['JUPYTER_HOST_URL'] + ':' + os.environ['JUPYTER_PORT']
...
#  Default: ''
c.NotebookApp.keyfile = '/home/jovyan/jupyterlite.key'
...
#         as local as well.
#  Default: ['localhost']
c.NotebookApp.local_hostnames = [os.environ['JUPYTER_HOST_NAME']]
...
c.NotebookApp.tornado_settings = {
    'headers': {
        'Content-Security-Policy': "frame-ancestors " + os.environ['JUPYTER_HOST_URL'] + " 'self' "
    }
}
...
#  Choices: any of ['sha3_512', 'blake2s', 'blake2b', 'sha3_224', 'sha3_384', 'sha1', 'sha224', 'md5', 'sha384', 'sha3_256', 'sha256', 'sha512']
#  Default: 'sha256'
