 ...
 * @author Cosmin Cara
 */
public class LSADateParameterConverter extends DefaultParameterConverter<LocalDateTime> {
    private static final String DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.S'Z'";
    private final DateTimeFormatter dateFormat;

    public LSADateParameterConverter(QueryParameter<LocalDateTime> parameter) {
        super(parameter);
